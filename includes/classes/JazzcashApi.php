...
{ 
    ...
    function __construct()
    {
		...
		define('JAZZCASH_MERCHANT_ID', 'MC18489');
        define('JAZZCASH_PASSWORD', 'yx032zb026');
        define('JAZZCASH_INTEGERITY_SALT', 't9u023ww4u');
        ...
        define('JAZZCASH_RETURN_URL', '');
        define('JAZZCASH_HTTP_POST_URL', 'https://sandbox.jazzcash.com.pk/ApplicationAPI/API/2.0/Purchase/DoMWalletTransaction');
        define('JAZZCASH_CARD_API_URL', 'https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/');
